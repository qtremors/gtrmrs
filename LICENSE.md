...
**Tremors Source License (TSL) — Version 1.0**
...
- Include a link to the original repository: `https://github.com/qtremors/gtrmrs`
...
```
Based on gtrmrs by Tremors
https://github.com/qtremors/gtrmrs
```
